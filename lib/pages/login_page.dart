...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 139, 137, 234),
      body: SafeArea(
        child: Center(
          child: Column(
              ...
              const Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Forgot Password?',
                      style: TextStyle(color: Color.fromARGB(255, 199, 18, 18)),
                    ),
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'You can login with these as well',
                        style:
                            TextStyle(color: Color.fromARGB(255, 223, 10, 10)),
                      ),
                    ),
                    Expanded(
                      child: Divider(
